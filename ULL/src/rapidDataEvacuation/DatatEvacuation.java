...
public class DatatEvacuation {
	...
	public static void main(String[] args) {
		...
		for(int NumContent =100; NumContent<=NumLimit;NumContent=NumContent+100)
		{
		   long startTime =  System.currentTimeMillis();
		   
	
	       Constant.conNum = 100;//NumContent;
	
		   
		    String mode = Constant.mode1;
			...
			result.filewrite("Result/result_"+seed+".csv", "totalContentRisk: ,"+totalContentRisk);
	...
	public static void run(Functions_Rapid_DataEvacuation function,String mode,file_out_put result){
    	...
    	function.readAvaDisasterRegion(ReadRiskFileName,phyLayer);
    	...
    	function.setLinkRisk(phyLayer, rand);
    	
    	//phyLayer.OutputAllLink();
      	function.outputLinkRisk(phyLayer, rand);
    
      	function.calRouteRiskAllRoute(phyLayer);
    	...
    	*/
    	...
    	OutputContentSie(rapidConetentList);
    	//read the disaster Reg
    //	function.readAvaDisasterRegion(ReadRiskFileName,phyLayer);
    //  function.setDisasterRisk(phyLayer);
    ...
    //		ContentDivision(rapidConetentList);
    	...
    	for(Content iCon:rapidConetentList)
		{
        	...
        	//    	Strategy_LDR_RDE(phyLayer,iCon,avaDataCenterlist);
        		...
        		//	TestStrategy_MultiPath_SubContent_SingleDestinationNode(phyLayer,iCon,avaDataCenterlist);	
        			TestStrategy(phyLayer,iCon,avaDataCenterlist);	
    		}
    ...
    */
	...
	public static void OutputContentFragmentation(ArrayList<Content> contentList)
	{
		...
		for(Content iCon:contentList)
		{
			System.out.println("The "+iCon.getIndex()+" Content");
			for(Content subNewCon:iCon.getSubContentList())
			{
				System.out.println("Sub:　"+subNewCon.getIndex());
			}
		}
	}
